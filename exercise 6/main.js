...
},
{
  ...
  pages: 377,
  ebook:false,
  cover: "https://www.uua.org/files/styles/max_1200x1200/public/png/a/asset_upload_file549_221535.png?itok=Io8JKsM4"
  ...
  if (shelf){
    if(books instanceof Array){
      for (let book of books){
        ...
        <img class="cover" src="${book.cover}" alt="Cover Art"> </img>
        <div class="book-info">
